...
class UIFunctions(MainWindow):
    ...
    def uiDefinitions(self):
        ...
        # CLOSE
        self.ui.btn_close.clicked.connect(lambda: UIFunctions.inchide(self))
    ...
    def inchide(self):
        if  self.ui.stackedWidget.currentIndex() == 2:
            ...
            msgBox.setText("Inainte de a inchide aplicatia, trebuie sa termini inregistrarea acestui contract.\nCompleteaza detaliile de mai jos si apasa butonul \"Genereaza contract\"")
            ...
            listaDB = "/BazaDate"
            copyLista = "/BazaDate/CopyDB/DB.xlsx"
            originalDB = currentDir + listaDB
            copyDB = currentDir + copyLista
            shutil.copy(copyDB, originalDB)
            self.close()
